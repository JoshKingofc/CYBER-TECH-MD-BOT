...
global.channelLink = "https://whatsapp.com/channel/0029Vb5MqwZFSAtCSnOr293n";
global.ytch = " THE GAME";
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || ' 120363401845425966@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || ' 120363401845425966@newsletter';
